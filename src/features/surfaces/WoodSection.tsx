      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div data-reveal-left>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/20 text-amber-300 text-xs font-bold uppercase tracking-widest mb-3 border border-amber-500/30">
              <Sparkles className="w-3.5 h-3.5" /> Wood Finishes
            </div>
            <h2 className="font-display text-4xl md:text-6xl text-amber-50 mt-3 leading-tight">Bring Wood to Life</h2>
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar pb-4" data-reveal-right>
            {woodImages.map((src, i) => (
              <div key={i} className="flex-shrink-0 w-64 aspect-[3/4] rounded-2xl overflow-hidden group shadow-2xl border border-amber-700/20">
                <div
